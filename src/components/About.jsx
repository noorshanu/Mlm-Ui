...
function About() {
  return (
    <section className="py-4 sm:py-14 relative">
      <img src="images/part2.png" alt="" className=" absolute top-20 h-[230px] sm:h-[537px] " />

      <div className="container-wrapper relative z-20">
        <div className="flex justify-between items-center flex-col sm:flex-row gap-6">
          <img src="images/part1.png" alt="" className=" h-[300px] sm:h-[558px] ml-0 sm:ml-[13%] mt-0 sm:mt-[-5%]" />
          <div> 
